...
# Set up database
engine = create_engine('postgres://lyyulpfcydrtxu:de9fdb7e432c14c87299e77d5efcde7685fe11ad4a23e5396dcf16785ce6c084@ec2-34-233-186-251.compute-1.amazonaws.com:5432/d1sdm9dvfb0u8c')
...
def register():
    ...
    if request.method == "POST":
        ...
        if not request.form.get("email"):
            return render_template("error.html", message="You must provide an email")

        # Query database for email
        userCheck = db.execute("SELECT * FROM users WHERE email = :email",
        ...
        # Ensure user submitted the confirmation
